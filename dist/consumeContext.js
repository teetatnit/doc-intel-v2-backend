...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./RabbitMqEndpointAddress"], factory);
    }
    ...
    var ConsumeContext = /** @class */ (function () {
        ...
        ConsumeContext.prototype.respond = function (message, cb) {
            return __awaiter(this, void 0, void 0, function () {
                var address, sendEndpoint;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.responseAddress) return [3 /*break*/, 2];
                            address = RabbitMqEndpointAddress_1.RabbitMqEndpointAddress.parse(this.receiveEndpoint.hostAddress, this.responseAddress);
                            sendEndpoint = this.receiveEndpoint.sendEndpoint(__assign({ exchange: address.name }, address));
...
//# sourceMappingURL=consumeContext.js.map