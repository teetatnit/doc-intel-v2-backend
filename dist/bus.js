...
(function (factory) {
    ...
    var MassTransitBus = /** @class */ (function (_super) {
        ...
        function MassTransitBus(hostAddress) {
            var _this_1 = _super.call(this) || this;
            _this_1.hostAddress = hostAddress;
        ...
        MassTransitBus.prototype.receiveEndpoint = function (queueName, cb, options) {
            ...
            var endpoint = new receiveEndpoint_1.ReceiveEndpoint(this, queueName, cb, __assign(__assign({}, receiveEndpoint_1.defaultReceiveEndpointOptions), options));
        ...
        MassTransitBus.prototype.requestClient = function (args) {
            var sendEndpoint = this.busEndpoint.sendEndpoint(args);
            return new requestClient_1.RequestClient(this.busEndpoint, sendEndpoint, args.requestType, args.responseType);
        };
        ...
        MassTransitBus.prototype.connect = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                var _this_1 = this;
                return __generator(this, function (_a) {
                    //console.log("bus label ",_a.label);
                    switch (_a.label) {
                        case 0:
                            _this = this;
                        ...
                        case 1:
                            ...
                            this.connection = amqplib_1.connect(this.hostAddress + '?heartbeat=60', opts);
                            return [4 /*yield*/, this.connection];
                        case 2:
                            connection = _a.sent();
                            ...
                            connection.on('close', function () {
                                _this_1.emit('disconnect', _this_1.hostAddress);
    ...
    var defaults = {
        host: config.RabbitMQ.username + ':' + config.RabbitMQ.password + '@' + config.RabbitMQ.host,   //'QAintell01:p%40ssw0rd01@172.30.228.120', 
        port: config.RabbitMQ.port,
        virtualHost: config.RabbitMQ.virtualHost,
        ssl: config.RabbitMQ.ssl.enabled,
    };
    function masstransit(options) {
        var _this_1 = this;
        if (options === void 0) { options = defaults; }
        var settings = __assign(__assign({}, defaults), options);
        var hostAddress = new RabbitMqEndpointAddress_1.RabbitMqHostAddress(settings);
        var bus = new MassTransitBus(hostAddress);
