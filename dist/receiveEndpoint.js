...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "class-transformer", "./messageContext", "./serialization", "./transport", "./RabbitMqEndpointAddress"], factory);
    }
    ...
    var ReceiveEndpoint = /** @class */ (function (_super) {
        ...
        function ReceiveEndpoint(bus, queueName, cb, options) {
            ...
            _this_1.hostAddress = bus.hostAddress;
            _this_1._messageTypes = {};
            if (cb)
                cb(_this_1);
            var settings = __assign({ name: queueName }, options);
            _this_1.address = new RabbitMqEndpointAddress_1.RabbitMqEndpointAddress(bus.hostAddress, settings);
...
//# sourceMappingURL=receiveEndpoint.js.map